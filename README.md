About apache-airflow-providers-datadog
======================================
...
Once the `conda-forge` channel has been enabled, `apache-airflow-providers-datadog` can be installed with:

```
conda install apache-airflow-providers-datadog
```

It is possible to list all of the versions of `apache-airflow-providers-datadog` available on your platform with:
